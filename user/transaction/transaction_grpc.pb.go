...
const (
	Transaction_CheckToken_FullMethodName = "/Transaction/CheckToken"
)
...
func (c *transactionClient) CheckToken(ctx context.Context, in *CheckTokenRequest, opts ...grpc.CallOption) (*CheckTokenResponse, error) {
...
func (UnimplementedTransactionServer) CheckToken(context.Context, *CheckTokenRequest) (*CheckTokenResponse, error) {
...
func _Transaction_CheckToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServer).CheckToken(ctx, req.(*CheckTokenRequest))
	}
...
var Transaction_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "entities/protos/transaction.proto",
}
